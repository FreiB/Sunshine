package com.nir.sunshine.app.sync;
...
import com.nir.sunshine.app.MainActivity;
import com.nir.sunshine.app.R;
import com.nir.sunshine.app.Utility;
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                boolean notify = prefs.getBoolean(getContext().getString(R.string.pref_notifications_key), true);
                if (notify) {
                    notifyWeather();
                }
            }
    ...
    private void notifyWeather() {
        ...
        if (System.currentTimeMillis() - lastSync >= DAY_IN_MILLIS) {
            ...
            if (cursor.moveToFirst()) {
                ...
                PendingIntent pIntent = TaskStackBuilder.create(getContext())
